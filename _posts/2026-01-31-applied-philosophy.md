...
3. There is a `$GOTH` ticker on [bags.fm](https://bags.fm/BJM8YzhZ6Mu2iccB1RVhHiEGFoU76ivYfAU5nRyKBAGS).  This is an experimental meme coin which I did not create, but the 1% transaction fees from it do support the project.  I don't endorse or promote the project, but I observe that if meme coins are your thing, this is one way that the `goth` language can receive support.  This is not financial advice and I'm not a financial advisor.  `$GOTH` is a speculative instrument with no tie to the project, roadmap, or utility.  I'm claiming these fees out of curiosity about the platform and its model, not because I think this token has value.  My only connection is being designated as fee recipient.
